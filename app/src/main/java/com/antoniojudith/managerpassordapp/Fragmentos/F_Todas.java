package com.antoniojudith.managerpassordapp.Fragmentos;
...
import com.antoniojudith.managerpassordapp.Adaptador.Adaptador_password;
import com.antoniojudith.managerpassordapp.BaseDeDatos.BDHelper;
import com.antoniojudith.managerpassordapp.BaseDeDatos.Constants;
...
public class F_Todas extends Fragment {
    ...
    private void CargarRegistros(String orderby) {
        EstadoOrden = orderby;
        Adaptador_password adaptador_password = new Adaptador_password(getActivity(), helper.ObtnerTodosRegistros(
                orderby));
    ...
    private void Visualizar_Total_Registros(){
        ...
        int total = helper.obtnerNumeroRegistros();
