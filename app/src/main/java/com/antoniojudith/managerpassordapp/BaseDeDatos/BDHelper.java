package com.antoniojudith.managerpassordapp.BaseDeDatos;
...
public class BDHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS "+ Constants.BD_NAME);
        onCreate(db);
    }
    ...
    public long insertarRegistro(String titulo, String cuenta, String nombreUsuario, String password, String sitioWeb,
                                 String nota, String imagen, String T_Rggistro, String T_actualizacion)
    {
            SQLiteDatabase db = this.getWritableDatabase();
            ...
            values.put(Constants.C_NOMBRE_USUARIO, nombreUsuario);
            values.put(Constants.C_PASSWORD, password);
            values.put(Constants.C_SITIO_WEB, sitioWeb);
            values.put(Constants.C_NOTA, nota);
            values.put(Constants.C_IMAGEN, imagen);
            values.put(Constants.C_TIEMPO_REGISTRO, T_Rggistro);
    ...
    public ArrayList<Password> ObtnerTodosRegistros(String orderby){
        ArrayList<Password> passwordList = new ArrayList<>();
        // consulta para seleccionar el registro
        String selectQuery = "SELECT * FROM "+Constants.TABLE_NAME + " ORDER BY "+ orderby;
    ...
    public int obtnerNumeroRegistros(){
