...
public class Agregar_Actualizar_Registro extends AppCompatActivity {
    ...
    String id, titulo, cuenta, nombre_usuario, password, sitioWeb, nota, tiempo_registro, tiempo_actualizacion;
    ...
    private void ObtenerInformacion(){
        ...
        if (MODO_EDICION){
            ...
            sitioWeb = intent.getStringExtra("SITIO_WEB");
    ...
    private void Agregar_Actualizar_R(){
        ...
        sitioWeb = EtSitioWeb.getText().toString().trim();
