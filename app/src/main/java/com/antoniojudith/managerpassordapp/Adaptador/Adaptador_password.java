package com.antoniojudith.managerpassordapp.Adaptador;
...
import com.antoniojudith.managerpassordapp.Detalle.Detalle_registro;
import com.antoniojudith.managerpassordapp.MainActivity;
import com.antoniojudith.managerpassordapp.Modelo.Password;
import com.antoniojudith.managerpassordapp.OpcionesPassword.Agregar_Actualizar_Registro;
...
public class Adaptador_password  extends  RecyclerView.Adapter<Adaptador_password.HolderPassword>{
    ...
    public void onBindViewHolder(@NonNull HolderPassword holder, @SuppressLint("RecyclerView") int position) {
            Password modelo_passord = passwordList.get(position);
            String id = modelo_passord.getId();
            String titulo = modelo_passord.getTitulo();
            String cuenta = modelo_passord.getCuenta();
            String nome_usuario = modelo_passord.getNombre_usuario();
            String password = modelo_passord.getPassword();
            String sitio_web = modelo_passord.getSitio_web();
            String nota= modelo_passord.getNota();
            String imagen = modelo_passord.getImagen();
            String tiempo_registro = modelo_passord.getT_registro();
            String tiempo_actualizacion = modelo_passord.getT_actualizacion();
            ...
            holder.Ib_mas_opcion.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // cuando usuario presiona en el image button
    ...
    class HolderPassword extends RecyclerView.ViewHolder{
        ...
        public HolderPassword(@NonNull View itemView) {
            ...
            Ib_mas_opcion = itemView.findViewById(R.id.Ib_mas_opcion);
